...
namespace StardopPoolMinigame.Constants
{
    static class GameConstants
    {
        public class Ball
        {
            ...
            /// <summary>
            /// Distance traveled between <see cref="MinigameFramework.Attributes.Orientation"/> updates.
            /// </summary>
        ...
        public class Cue
        {
            ...
            /// </summary>
            public static int MaximumDistanceFromCueBall = (int)Math.Round((Ball.Radius + 85) * RenderHelpers.TileScale());

            /// <summary>
            /// Minimum distance <see cref="Entities.Cue"/> can be dragged away from the cue <see cref="Entities.Ball"/> while striking.
            /// </summary>
            public static int MinimumDistanceFromCueBall = (int)Math.Round((Ball.Radius + 5) * RenderHelpers.TileScale());
