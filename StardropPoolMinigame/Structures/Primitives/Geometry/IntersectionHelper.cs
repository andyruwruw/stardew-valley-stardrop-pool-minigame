...
namespace StardropPoolMinigame.Primitives.Helpers
{
    /// <summary>
    ...
    class IntersectionHelper
    {
        ...
        private static bool IsIntersectingCircles(Circle circle1, Circle circle2)
        {
        ...
        private static bool IsIntersectingLines(Line line1, Line line2)
        {
            float o1 = Orientation(line1.GetStart(), line2.GetStart(), line1.GetEnd());
            float o2 = Orientation(line1.GetStart(), line2.GetStart(), line2.GetEnd());
            float o3 = Orientation(line1.GetEnd(), line2.GetEnd(), line1.GetStart());
            float o4 = Orientation(line1.GetEnd(), line2.GetEnd(), line2.GetStart());
            ...
            if (o1 == 0 && OnSegment(line1.GetStart(), line1.GetEnd(), line2.GetStart()))
            {
                return true;
            }

            if (o2 == 0 && OnSegment(line1.GetStart(), line2.GetEnd(), line2.GetStart()))
            {
                return true;
            }

            if (o3 == 0 && OnSegment(line1.GetEnd(), line1.GetStart(), line2.GetEnd()))
            {
                return true;
            }

            if (o4 == 0 && OnSegment(line1.GetEnd(), line2.GetStart(), line2.GetEnd()))
            {
                return true;
            }
        ...
        private static bool IsIntersectingCircleAndRectangle(Circle circle, Rectangle rectangle)
        {
        ...
        private static bool IsIntersectingCircleAndLine(Circle circle, Line line)
        {
            if (VectorHelper.Pythagorean(line.GetStart(), circle.GetCenter()) <= circle.GetRadius()
                || VectorHelper.Pythagorean(line.GetEnd(), circle.GetCenter()) <= circle.GetRadius())
            {
                return true;
            }
            ...
            return VectorHelper.Pythagorean(closestPoint, circle.GetCenter()) <= circle.GetRadius();
        }
        ...
        private static bool IsIntersectingLineAndRectangle(Line line, Rectangle rectangle)
        {
            // Not implemented
            return true;
        }
