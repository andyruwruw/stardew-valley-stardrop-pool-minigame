...
namespace MinigameFramework.Entities
{
    ...
    abstract class Entity : IEntity
    {
        ...
        {
            Vector2 destination = overrideDestination == null ? GetRawDestination() : (Vector2)overrideDestination;
        ...
        /// <summary>
        /// Destination before filters.
        /// </summary>
        protected virtual Vector2 GetRawDestination()
        {
            Vector2 topLeft = GetTopLeft();

            return RenderHelpers.ConvertAdjustedScreenToRaw(topLeft);
        }
